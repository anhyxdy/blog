...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/anhyxdy", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://github.com/anhyxdy",
		},
		{
			name: "Email",
			icon: "fa6-regular:envelope",
			url: "mailto:heyx2028@163.com",
		},
	],
};
